...
- **Turki Baseline Match Guard (v2.5.1)**: מוצרים מחנות אחרת מוצגים ונשמרים רק אם יש להם מקבילה אמיתית בטורקי. פילטר זה מונע false positives כמו השוואת יינות ב-149₪ שלא נמצאים בטורקי ל-baseline הלא-רלוונטי שלהם.
